...
class mod_cms_Start extends icms_ipf_seo_Object
{
	...
	{		
		...
		// Create a section and intialise image functionality
		$this->openFormSection("logo_section", _AM_CMS_START_OPEN_LOGO);
		$this->quickInitVar("logo", XOBJ_DTYPE_IMAGE, FALSE);
		$this->closeFormSection("logo_section");
		...
		// Create a section and intialise extended_text functionality
		$this->openFormSection("ext_section", _AM_CMS_START_OPEN_EXT);
		$this->setControl("extended_text", "dhtmltextarea");
		$this->quickInitVar("extended_text", XOBJ_DTYPE_TXTAREA, FALSE);
		$this->closeFormSection("ext_section");

		// Create a section and intialise extended_text functionality
		$this->openFormSection("history_section", _AM_CMS_START_OPEN_HISTORY);
		$this->setControl("history", "dhtmltextarea");
		$this->quickInitVar("history", XOBJ_DTYPE_TXTAREA, FALSE);
		$this->closeFormSection("history_section");
		...
		// Create a section and intialise SEO functionality
		$this->openFormSection("seo_section", _AM_CMS_START_OPEN_SEO);
		$this->initiateSeo();
		$this->closeFormSection("seo_section");
		
		// Create a section and intialise DO functionality
		$this->openFormSection("do_section", _AM_CMS_START_OPEN_DO);
		$this->initCommonVar("dohtml");
		//$this->initCommonVar("dobr");
		$this->initCommonVar("doimage");
		$this->initCommonVar("dosmiley");
		$this->closeFormSection("do_section");
